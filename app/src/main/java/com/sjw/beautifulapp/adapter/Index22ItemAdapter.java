...
public class Index22ItemAdapter extends RecyclerView.Adapter<Index22ItemAdapter.MyViewHolder> {
    private List<Index2Item2ItemBean>  list;

    private Context context;

    public Index22ItemAdapter(List<Index2Item2ItemBean>  list, Context context){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_index2_rv2_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final Index2Item2ItemBean bean=list.get(position);
